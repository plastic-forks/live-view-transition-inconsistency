...
defmodule SamplePhoenix.SampleLive do
  ...
  def render("live.html", assigns) do
    ...
    <% # USE THE FIXED phoenix_live_view.min.js %>
    <script src="https://cdn.jsdelivr.net/gh/plastic-forks/phoenix_live_view@dig-transition-problem/priv/static/phoenix_live_view.min.js"></script>
